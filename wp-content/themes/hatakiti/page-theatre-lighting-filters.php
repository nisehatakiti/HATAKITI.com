...
.hk-filter-note{font-size:13px;color:var(--hk-fg-dim);line-height:1.8}.hk-gel-result-head{display:flex;justify-content:space-between;align-items:end;gap:16px}.hk-gel-result-controls{display:flex;align-items:center;gap:14px;color:var(--hk-fg-dim);font-size:13px}.hk-gel-result-controls select{margin-left:6px;padding:8px;border:1px solid var(--hk-border);background:var(--hk-bg-card);color:var(--hk-fg)}.hk-gel-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}.hk-gel-card{border:1px solid var(--hk-border);background:var(--hk-bg-elevated);overflow:hidden;transition:border-color .15s,transform .15s}.hk-gel-card:hover{border-color:var(--hk-accent-warm);transform:translateY(-2px)}.hk-gel-card-link{display:block;color:inherit;text-decoration:none}.hk-gel-card.has-reference-color{background:var(--hk-gel-card-color);color:var(--hk-gel-card-fg);border-color:var(--hk-gel-card-border)}.hk-gel-card.has-reference-color .hk-gel-meta{background:var(--hk-gel-card-color);color:var(--hk-gel-card-fg)}.hk-gel-card.has-reference-color .hk-gel-brand{color:var(--hk-gel-card-fg);opacity:.82}.hk-gel-card.has-reference-color .hk-gel-meta dl div{border-top-color:var(--hk-gel-card-border)}.hk-gel-card.has-reference-color .hk-gel-meta dt,.hk-gel-card.has-reference-color .hk-gel-card-note,.hk-gel-card.has-reference-color .hk-gel-card-description{color:var(--hk-gel-card-muted)}.hk-gel-card.has-reference-color .hk-gel-tags span{border-color:var(--hk-gel-card-border);color:var(--hk-gel-card-muted)}.hk-gel-swatch{height:190px;background:var(--hk-gel-color);display:flex;flex-direction:column;align-items:center;justify-content:center;color:#fff;text-shadow:0 1px 3px rgba(0,0,0,.55)}.hk-gel-swatch.light{color:#222;text-shadow:none}.hk-gel-swatch span{font-size:11px;letter-spacing:.08em}.hk-gel-swatch strong{font-size:21px;margin-top:6px}.hk-gel-swatch small{margin-top:6px;font-size:10px}.hk-gel-swatch-missing{background:repeating-linear-gradient(135deg,var(--hk-bg-card),var(--hk-bg-card) 10px,var(--hk-bg-elevated) 10px,var(--hk-bg-elevated) 20px);color:var(--hk-fg-dim);text-shadow:none;text-align:center}.hk-gel-meta{padding:18px}.hk-gel-brand{font-size:11px;color:var(--hk-accent-warm)}.hk-gel-meta h3{font-family:var(--hk-font-serif);margin:5px 0 10px}.hk-gel-card-description{margin:0 0 13px;color:var(--hk-fg-dim);font-size:12px;line-height:1.75}.hk-gel-meta dl{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:0}.hk-gel-meta dl div{border-top:1px solid var(--hk-border);padding-top:8px}.hk-gel-meta dt{font-size:10px;color:var(--hk-fg-faint)}.hk-gel-meta dd{margin:3px 0 0;font-size:12px}.hk-gel-tags{display:flex;flex-wrap:wrap;gap:5px;margin-top:12px}.hk-gel-tags span{font-size:10px;padding:4px 7px;border:1px solid var(--hk-border);color:var(--hk-fg-dim)}.hk-gel-card-note{font-size:10px;color:var(--hk-fg-faint);margin:12px 0 0}.hk-gel-empty{border:1px dashed var(--hk-border);padding:40px;text-align:center;color:var(--hk-fg-dim)}.hk-gel-empty h2,.hk-gel-empty h3{font-family:var(--hk-font-serif);color:var(--hk-fg)}.hk-gel-result-foot{display:flex;justify-content:space-between;align-items:center;margin-top:20px;color:var(--hk-fg-faint);font-size:12px}.hk-gel-pagination{display:flex;gap:5px}.hk-gel-pagination button{min-width:34px;padding:7px;border:1px solid var(--hk-border);background:var(--hk-bg-card);color:var(--hk-fg);cursor:pointer}.hk-gel-pagination button.is-current{border-color:var(--hk-accent-warm);color:var(--hk-accent-warm)}
...
(function(){
    ...
    function card(record){
        ...
        const rgbValues=record.reference_rgb||[255,255,255];
        const luminance=0.299*rgbValues[0]+0.587*rgbValues[1]+0.114*rgbValues[2];
        const cardStyle=record.reference_hex ? ' style="--hk-gel-card-color:'+esc(record.reference_hex)+';--hk-gel-card-fg:'+(luminance>205?'#222':'#fff')+';--hk-gel-card-muted:'+(luminance>205?'rgba(0,0,0,.68)':'rgba(255,255,255,.82)')+';--hk-gel-card-border:'+(luminance>205?'rgba(0,0,0,.18)':'rgba(255,255,255,.28)')+'"' : '';
        const cardClass=record.reference_hex ? ' has-reference-color'+(luminance>205?' is-light':'') : '';
        return '<article class="hk-gel-card'+cardClass+'"'+cardStyle+'><a class="hk-gel-card-link" href="'+href+'">'+swatch(record)+'<div class="hk-gel-meta"><div class="hk-gel-brand">'+esc(record.manufacturer||'')+' / '+esc(record.series||'')+'</div><h3>'+esc(record.color_number||'')+' '+esc(record.color_name||'')+'</h3>'+(record.notes?'<p class="hk-gel-card-description">'+esc(record.notes)+'</p>':'')+'<dl><div><dt>透過率</dt><dd>'+esc(record.transmission_display||'未登録')+'</dd></div><div><dt>参考色</dt><dd>'+esc(record.reference_hex||'未登録')+'</dd></div></dl><div class="hk-gel-tags">'+uses+'</div><p class="hk-gel-card-note">※表示色はRGBによる参考色です。</p></div></a></article>';
    }
