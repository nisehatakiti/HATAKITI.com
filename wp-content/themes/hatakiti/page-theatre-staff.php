...
<header class="hk-staff-hero"><p class="hk-textbook-kicker">HATAKITI 演劇の教科書｜照明</p><h1>ゼラ色見本データベース</h1><p>舞台照明用カラーフィルターを、メーカー・シリーズ・色番号・色名・透過率・用途・注意点から整理するためのデータベースです。</p></header>
<section class="hk-section"><div class="hk-section-head"><h2>色を調べる</h2></div><div class="hk-filter-search">
<label>メーカー<input type="search" placeholder="例：Rosco / LEE"></label><label>シリーズ<input type="search" placeholder="例：Roscolux"></label><label>色番号<input type="search" placeholder="例：26"></label><label>色名<input type="search" placeholder="例：Bright Red"></label>
</div><p class="hk-filter-note">色番号はメーカー・シリーズごとに意味が異なります。「メーカー＋シリーズ＋番号」を1セットとして管理します。</p></section>
<section class="hk-section"><div class="hk-section-head"><h2>登録項目</h2></div><div class="hk-filter-record">
<div><span>メーカー名</span><strong>例：Rosco</strong><small>メーカーを明記</small></div><div><span>シリーズ名</span><strong>例：Roscolux</strong><small>製品体系を明記</small></div><div><span>色番号</span><strong>例：26</strong><small>カタログ上の番号</small></div><div><span>色名</span><strong>メーカー公称色名</strong><small>原表記を保持</small></div><div><span>透過率</span><strong>メーカー公表値</strong><small>単位・測定条件も記録</small></div><div><span>用途</span><strong>人物／背景／時間／心理など</strong><small>実際の舞台での使い方</small></div><div><span>注意点</span><strong>熱・色変化・器具との相性など</strong><small>メーカー資料と現場知識を区別</small></div>
</div></section>
<section class="hk-section"><div class="hk-section-head"><h2>色見本レコード</h2></div><div class="hk-filter-table-wrap"><table class="hk-filter-database"><thead><tr><th>色見本</th><th>メーカー</th><th>シリーズ</th><th>番号</th><th>色名</th><th>透過率</th><th>用途</th><th>注意点</th></tr></thead><tbody><tr><td><div class="hk-swatch-placeholder">色見本</div></td><td>—</td><td>—</td><td>—</td><td>—</td><td>—</td><td>人物／背景／時間／心理</td><td>メーカー資料確認</td></tr></tbody></table></div><p class="hk-filter-note">実データは推測で埋めず、メーカーの公式資料・製品データに基づいて追加します。</p></section>
<section class="hk-section"><div class="hk-section-head"><h2>使い方</h2></div><div class="hk-four"><div><b>① 色番号を調べる</b><p>メーカーとシリーズを先に確認してから検索。</p></div><div><b>② 色を比較する</b><p>色名だけで判断せず、色見本・透過率・光源条件を確認。</p></div><div><b>③ 用途から探す</b><p>夕景、月光、人物、背景など目的から候補を絞る。</p></div><div><b>④ 現場で確認する</b><p>器具、光源、舞台素材、カメラなどで見え方が変わります。</p></div></div></section>
