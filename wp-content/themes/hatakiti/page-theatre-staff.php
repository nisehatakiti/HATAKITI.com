...
<style>.hk-textbook-figure{margin:28px 0 34px;text-align:center}.hk-textbook-figure img{display:block;width:100%;height:auto;border:1px solid var(--hk-border);background:#0b0d10}.hk-textbook-figure figcaption{margin-top:9px;color:var(--hk-fg-dim);font-size:12px;line-height:1.7}@media(max-width:700px){.hk-textbook-figure{margin:22px 0 28px}.hk-textbook-figure figcaption{font-size:11px}}</style><header class="hk-staff-hero"><p class="hk-textbook-kicker">HATAKITI 演劇の教科書｜舞台を作る</p><h1>舞台スタッフの仕事</h1><p>役者だけでは舞台はできません。照明、音響、舞台監督、美術、制作など、それぞれの専門性が一つの公演を作ります。</p></header>
